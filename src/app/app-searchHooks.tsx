...
export interface IAppSearchProps {
	...
	searchState: IAppSearchStateHooks
}
export interface IAppSearchStateHooks {
...
export default function TabSearch(props: IAppSearchProps) {
	...
	//const todo = useContext(SearchStateContext); // TODO:
	//console.log(todo)
	...
	useEffect(() => {
		...
		return () => {
			console.log('BYE!')
			/* causes a loop bc source changesm which fires render!
